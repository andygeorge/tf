...
- [x] `make check` passes; block capture tests pass for all resource change types.
...
- [x] `make check` passes; viewer state tests cover all navigation and toggle paths.
...
- [x] Manual smoke test: `tf plan` in a terminal opens the interactive viewer;
...
- [x] README updated with interactive diff toggle documentation.
- [x] Manual smoke test: navigate, expand, collapse, and quit work correctly.
